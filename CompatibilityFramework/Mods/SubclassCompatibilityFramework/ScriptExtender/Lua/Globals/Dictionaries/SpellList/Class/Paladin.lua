...
DictUtils.InsertField(paladin.Base, { AlwaysPrepared = {}, Aura = {} })
DictUtils.InsertField(paladin.Base.AlwaysPrepared, {
...
DictUtils.InsertField(paladin.Base.Aura, {
...
DictUtils.InsertField(paladin.Ancients, { Aura = {} })
DictUtils.InsertField(paladin.Ancients.Aura, {
  Seven = "f6e69adb-d2d3-4d38-aca1-639fb38cf0fd"
})
...
DictUtils.InsertField(paladin.Devotion, { Aura = {} })
DictUtils.InsertField(paladin.Devotion.Aura, {
  Seven = "7112a6f2-8100-40e8-a411-75cde8847b36"
})
...
DictUtils.InsertField(paladin.Oathbreaker, { Aura = {} })
DictUtils.InsertField(paladin.Oathbreaker.Aura, {
  Seven = "20c3ac99-a937-464c-810d-d2f50ba44e6e"
})
