...
Utils.MergeTables(tiefling.Base.Levels, {
  One = DictUtils.setupClassLevelEntry("56529178-3df2-4067-b1c0-e35fe82fbd37")
})

Utils.MergeTables(tiefling.Asmodeus.Levels, {
...
Utils.MergeTables(tiefling.Mephisto.Levels, {
...
Utils.MergeTables(tiefling.Zariel.Levels, {
