...
Strings.ERROR_FAILED_VALIDATION = "Validation Failure. Skipping support for mod with UUID: " 
...
Strings.ERROR_ACTION_RESOURCE_GROUP_EXISTS_IN_DICTIONARY = "Action Resource Group is already defined in Globals.ActionResourceGroups"
...
Strings.ERROR_ACTION_RESOURCE_GROUP_DOES_NOT_EXIST_IN_DICTIONARY = "Action Resource Group is not defined in Globals.ActionResourceGroups"
