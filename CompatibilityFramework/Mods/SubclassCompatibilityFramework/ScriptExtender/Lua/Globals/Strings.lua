...
Strings.DEP_SUBCLASS_API = "Deprecated Subclass API call(s) made. Compatibility Framework no longer requires API calls for adding Subclasses to a class. Please inform the authors of the following mods: "
Strings.DEP_SUBCLASS_JSON = "Deprecated Subclass Configuration(s) detected. Compatibility Framework no longer requires JSON configuration for adding Subclasses to a class. Please inform the authors of the following mods: "
