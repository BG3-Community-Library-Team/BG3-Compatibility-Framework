...
Strings.VAL_ERR_CLASS_DESCRIPTION_INVALID_PARENT = "'s Parent Class Descriotion is invalid. Please inform the author to confirm the ParentGuid value in ClassDescriptions."
